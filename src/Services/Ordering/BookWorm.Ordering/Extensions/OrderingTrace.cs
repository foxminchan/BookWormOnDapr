...
internal static partial class OrderingTrace
{
    [LoggerMessage(
        ...
        Message = "[[{Event}] - Order {OrderId} created"
    )]
    ...
    [LoggerMessage(
        EventId = 1,
        Level = LogLevel.Information,
        Message = "[[{Event}] - Order {OrderId} paid"
    )]
    public static partial void LogOrderPaid(ILogger logger, string? @event, Guid orderId);

    [LoggerMessage(
        EventId = 2,
        Level = LogLevel.Information,
        Message = "[[{Event}] - Order {OrderId} cancelled"
    )]
    ...
    [LoggerMessage(
        EventId = 3,
        Level = LogLevel.Information,
        Message = "[[{Event}] - Order {OrderId} completed"
    )]
