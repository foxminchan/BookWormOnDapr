...
) : PageModel
{
    ...
    )
    {
        ...
        var email =
            enumerable.FirstOrDefault(x => x.Type == JwtClaimTypes.Email)?.Value
        ...
        // user's display name
        var name =
            enumerable.FirstOrDefault(x => x.Type == JwtClaimTypes.Name)?.Value
        ...
        {
            var first =
                enumerable.FirstOrDefault(x => x.Type == JwtClaimTypes.GivenName)?.Value
                ?? enumerable.FirstOrDefault(x => x.Type == ClaimTypes.GivenName)?.Value;
            var last =
                enumerable.FirstOrDefault(x => x.Type == JwtClaimTypes.FamilyName)?.Value
